...
const songs = [
    ...
    {
        path: '/assets/musıc3.mp3',
        displayName: 'Carols Of The Bells',
        cover: '/assets/photo3.jpg',
        artist: 'Lindsey Stirling'
    },

    {
        path: '/assets/musıc4.mp3',
        displayName: 'Düşler Sokağı',
        cover: '/assets/photo4.jpg',
        artist: 'Feridun Düzağaç'
    },

    {
        path: '/assets/musıc5.mp3',
        displayName: 'Firuze',
